...
public class Account_01_NewCustomer_PageObjectParttern extends AbstractTest {
	...
	String addressFirstCharacterAsSpaceValue, customerCityNumericValue, customerCitySpecialCharactersValue,
	...
	String pINNumericValue, pINNumericMoreThan6DigitValue, pINNumericLessThan6DigitValue,
	...
	public void TC_03_NameCanNotHaveSpecialCharacters() {
		...
		System.out.println("NEW CUSTOMER - STEP: 2. Verify error message at Name field");
		Assert.assertTrue(
				newCustomerPageObject.isCustomerNameErrorMessageDisplayed("Special characters are not allowed"));
	}
