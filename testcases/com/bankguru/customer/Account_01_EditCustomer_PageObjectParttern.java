...
public class Account_01_EditCustomer_PageObjectParttern extends AbstractTest {
	WebDriver driver;
	...
	public void TC_01_CustomerIDCanNotBeEmpty() {
		...
		editCustomerPageObject = homePage.openEditCustomerPage(driver);
	...
	public void TC_02_CustomerIDCanNotBeNumeric() {
		...
		System.out.println("EDIT CUSTOMER - STEP: 1. Enter Numeric value in Customer ID field");
		editCustomerPageObject.enterValueInCustomerIDField(customerIDNotNumeric);

		System.out.println("EDIT CUSTOMER - STEP: 2. Verify error message at Customer ID field");
	...
	public void TC_03_CustomerIDCanNotHaveSpecialCharacters() {
		...
		System.out.println("EDIT CUSTOMER - STEP: 1. Enter Special Character in Customer ID field");
		editCustomerPageObject.enterValueInCustomerIDField(customerIDSpecialCharactersValue);

		System.out.println("EDIT CUSTOMER - STEP: 2. Verify error message at Customer ID field");
		Assert.assertTrue(
				editCustomerPageObject.isCustomerIDErrorMessageDisplayed("Special characters are not allowed"));
	}
	...
	public void TC_04_ValidCustomerID() {
		...
		System.out.println("EDIT CUSTOMER - STEP: 3. Verify redirect to Edit Customer page");
	...
	public String createNewCustomer() {
		newCustomerPageObject = homePage.navigateToNewCustomerPage();
